...
import useMarkgetglobar from '@/hooks/data/use-markget-global'
import useGlobalTheme from '@/hooks/use-global-theme'
import useLocales from '@/hooks/use-locales'
import { convertUnits } from '@/lib/utils'
import { AddSeparator, currencyFormat } from '@/lib/utils/currency-format'

import Modal from '@/components/common/bottom-sheet-modal'
import DateFormatText from '@/components/common/date-format-text'
import SurfaceWrap from '@/components/common/surface-wrap'
import Text from '@/components/common/text'
import { MarqueeTextSkeleton } from '@/components/skeleton-placeholder/coin-market-home'
