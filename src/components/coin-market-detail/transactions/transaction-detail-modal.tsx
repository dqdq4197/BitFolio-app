...
import { currencyFormat, getCurrencySymbol } from '@/lib/utils/currency-format'
import { changeCoinState } from '@/store/slices/portfolio'
import { TransactionType, removeTransaction } from '@/store/slices/transaction'

import EditButton from './edit-transaction-button'
import Modal from '@/components/common/bottom-sheet-modal'
import IncreaseDecreaseValue from '@/components/common/increase-decrease-value'
...
function TransactionDetailModal({
  ...
  onDismiss,
  ref,
}: DetailProps & { ref?: Ref<BottomSheetModal> }) {
        ...
        <>
            ...
            <TableWrap>
              ...
              <Row>
                <SubTitleWrap>
                  ...
                  <Text fontML>{t(`common.date`)}</Text>
                </SubTitleWrap>
                <Text fontML color100 bold>
              ...
              <Row>
                <SubTitleWrap>
                  ...
                  <Text fontML>{t(`common.quantity`)}</Text>
                </SubTitleWrap>
                <Text fontML color100 bold>
              ...
              {data.type !== 'transfer' && (
                <Row>
                  <SubTitleWrap>
                    ...
                    <Text fontML>{t(`common.price per coin`)}</Text>
                  </SubTitleWrap>
                  <Text fontML color100 bold>
                    {currencyFormat({
              ...
              {data.type !== 'transfer' && (
                <Row>
                  ...
                  <Text fontML color100 bold>
                    {currencyFormat({
                      value:
                        data.quantity * data.pricePerCoin[currency] +
                        data.fee[currency],
                      prefix: getCurrencySymbol(currency),
                    })}
                  </Text>
              ...
              {data.notes && (
                <Notes>
                  <SubTitleWrap>
                    ...
                    <Text fontML>{t(`common.notes`)}</Text>
                  </SubTitleWrap>
          ...
          {data.type !== 'transfer' && (
            ...
            >
              <ChangeWrap>
                <Row>
                  <Text fontML>{t(`common.current value`)}</Text>
                ...
                <Row>
                  <Text fontML>{t(`common.percentage`)}</Text>
