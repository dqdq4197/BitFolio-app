...
import EmptyView from '@/components/coin-search/empty-view'
import ListFooter from '@/components/coin-search/list-footer'
import SearchBar from '@/components/coin-search/search-bar'
import SearchItem from '@/components/coin-search/search-item'
