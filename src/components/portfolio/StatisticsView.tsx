...
interface PerformerType extends CoinStatType, Pick<CoinMarketReturn, 'sparkline_in_7d' | 'image' | 'symbol'> {
...
const CardContainer = styled.View`
  width: ${({ theme }) => (width - parseInt(theme.content.spacing) * 2) / 2 - CARD_SPACING}px;
  background-color: ${({ theme }) => theme.base.background[200]};
  border-radius: ${({ theme }) => theme.border.m};
  padding: 13px;
`
