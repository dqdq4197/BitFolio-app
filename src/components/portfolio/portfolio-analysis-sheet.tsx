...
import { PortfolioStatsType } from '@/hooks/use-portfolio-stats'
...
import CommonAnalysis from './common-analysis'
...
const PortfolioAnalysisSheet = ({ portfolioStats }: SheetProps) => {
  ...
  return (
    <>
      ...
      <SurfaceWrap paddingBottomZero parentPaddingZero>
        <>
          <TabContainer>
            <Tab
              tabKey="allocation"
                ...
                Object.entries(portfolioStats.coins).length === 0 ? (
                  ...
                  <StatisticsView
                    ...
                    portfolio_all_time_pl={
                      portfolioStats?.portfolio_all_time_pl
                    }
                    portfolio_all_time_pl_percentage={
                      portfolioStats?.portfolio_all_time_pl_percentage
                    }
                  />
                )
              ) : (
